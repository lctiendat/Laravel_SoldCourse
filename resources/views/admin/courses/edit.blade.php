                    ...
                    <form action="{{ route('courses.update', $course->id) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    <label for="">{{ trans('pagination.course.content') }}</label>
                            ...
                            <div class="col-md-5">
                                ...
                                <img src="/uploads/{{ $course->thumbnail }}" width="100%" alt="img false">
                            ...
                            <div class="form-group text-center">
                                <button type="submit"
                                    class="btn btn-primary">{{ trans('pagination.update') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
